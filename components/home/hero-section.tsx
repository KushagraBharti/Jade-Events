    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          >
            <h1 className="text-7xl md:text-9xl lg:text-[12rem] font-serif font-bold leading-none tracking-tighter text-white mix-blend-difference">
          ...
          >
            <p className="max-w-md text-sm font-mono tracking-widest uppercase text-white/70">
              Curating immersive experiences in Frisco & DFW
            </p>
